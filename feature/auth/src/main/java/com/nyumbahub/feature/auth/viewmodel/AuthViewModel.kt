...
class AuthViewModel @Inject constructor(
    ...
    fun signUp(email: String, password: String, name: String, role: UserRole = UserRole.SEEKER, agency: String = "", phone: String = "") {
        viewModelScope.launch {
            _uiState.value = AuthUiState.Loading
            authRepository.signUpWithEmail(email, password, name, role, agency, phone)
                .onSuccess { _uiState.value = AuthUiState.Success }
